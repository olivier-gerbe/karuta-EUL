...
//----------------------------------
var appliname = 'EUL';
var karutaname = 'EUL'; // to share the same 'karuta-core' with multiple front-end
...
var navbar_title = {};
navbar_title["fr"] = "<img height='35px' src='"+karuta_url+"/application/img/eul.png'/>";
navbar_title["en"] = "<img height='35px' src='"+karuta_url+"/application/img/eul.png'/";
//-----------LOGIN PAGE -----------------------
